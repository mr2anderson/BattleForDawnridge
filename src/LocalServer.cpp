...
static void THREAD_EXCEPTION_SAFE(std::exception_ptr *unexpectedError, std::atomic_bool& stop, std::atomic_bool& running, std::atomic_bool &ready, std::atomic<uint16_t> &port) {
	running = true;
