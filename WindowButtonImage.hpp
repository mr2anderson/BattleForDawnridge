...
public:
	WindowButtonImage(const std::string& soundName1, const std::string& soundName2, const std::wstring& message, const std::wstring& buttonText, const std::string& pictureName, const Events& onFinish = Events(), uint32_t w = 400, uint32_t h = 225);
