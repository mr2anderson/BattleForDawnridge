...
std::wstring Sawmill::getIsNotBuiltYetStr() const {
	return L"ËÅÑÎÏÈËÊÀ ÅÙÅ ÍÅ ÏÎÑÒÐÎÅÍÀ\nÄîæäèòåñü êîíöà ñòðîèòåëüñòâà.";
}
std::wstring Sawmill::getBuildingFinishedStr() const {
	return L"ËÅÑÎÏÈËÊÀ ÏÎÑÒÐÎÅÍÀ\nÁëàãîäàðÿ Âàøèì ðàáî÷èì, ëåñîïèëêà óæå íà÷èíàåò äîáûâàòü ïåðâóþ äðåâåñèíó.";
}
...
std::wstring Sawmill::getDescription() const {
	return L"Ëåñîïèëêè îáåñïå÷èâàþò Âàø ãîðîä äðåâåñèíîé — îñíîâíûì ìàòåðèàëîì ñòðîèòåëüñòâà ãðàæäàíñêèõ ñîîðóæåíèé. Çàùèòà: " + std::to_wstring(this->getHP()) + L" / " + std::to_wstring(this->getMaxHP()) + L".";
}
std::wstring Sawmill::getResourcesOverStr() const {
	return L"ËÅÑÀ ÇÀÊÎÍ×ÈËÈÑÜ\nÎäíà èç Âàøèõ ëåñîïèëîê ïðåêðàùàåò ðàáîòó.";
}
std::wstring Sawmill::getUpgradeStartDescription() const {
	return L"ÍÀ×ÀÒÎ ÓËÓ×ØÅÍÈÅ ËÅÑÎÏÈËÊÈ\nÑáîð äðåâåñèíû áûë ïðèîñòàíîâëåí.";
}
std::wstring Sawmill::getUpgradeFinishDescription() const {
	return L"ÓËÓ×ØÅÍÈÅ ËÅÑÎÏÈËÊÈ ÇÀÂÅÐØÅÍÎ\nÑáîð äðåâåñèíû âîçîáíîâëåí.";
}
std::wstring Sawmill::getBusyWithUpgradingDescription() const {
	return L"ËÅÑÎÏÈËÊÀ ÍÅÄÎÑÒÓÏÍÀ\nÏîäîæäèòå, ïîêà áóäåò çàâåðøåíî óëó÷øåíèå.";
}
